...
def main(args):
    ...
    if args.nfkb_path:
        assert args.ktr_path is None
        dataset = OneDDataset(args.nfkb_path, args.data_path, remove_nans=True)
    elif args.ktr_path:
        assert args.nfkb_path is None
        dataset = OneDDataset(args.ktr_path, args.data_path, remove_nans=True)
