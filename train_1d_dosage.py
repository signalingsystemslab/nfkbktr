...
def parse_args():
    ...
    parser.add_argument('--ktr-p3c4-path', type=str, default=None)
    parser.add_argument('--ktr-cpg-path', type=str, default=None)
    parser.add_argument('--ktr-tnf-path', type=str, default=None)
    parser.add_argument('--ktr-lps-path', type=str, default=None)
    
     parser.add_argument('--nfkb-p3c4-path', type=str, default=None)
    parser.add_argument('--nfkb-cpg-path', type=str, default=None)
    parser.add_argument('--nfkb-tnf-path', type=str, default=None)
    parser.add_argument('--nfkb-lps-path', type=str, default=None)
...
def main(args):
    ...
    if args.ktr_cpg_path and args.ktr_lps_path and args.ktr_p3c4_path and args.ktr_tnf_path:
        cpg_dosage_dataset = DosageDataset(args.data_path, args.ktr_cpg_path)
        lps_dosage_dataset = DosageDataset(args.data_path, args.ktr_lps_path)
        p3c4_dosage_dataset = DosageDataset(args.data_path, args.ktr_p3c4_path)
        tnf_dosage_dataset = DosageDataset(args.data_path, args.ktr_tnf_path)
        
    elif args.nfkb_cpg_path and args.nfkb_lps_path and args.nfkb_p3c4_path and args.nfkb_tnf_path:
        cpg_dosage_dataset = DosageDataset(args.data_path, args.nfkb_cpg_path)
        lps_dosage_dataset = DosageDataset(args.data_path, args.nfkb_lps_path)
        p3c4_dosage_dataset = DosageDataset(args.data_path, args.nfkb_p3c4_path)
        tnf_dosage_dataset = DosageDataset(args.data_path, args.nfkb_tnf_path)
        
    else:
        raise ValueError('need to specify at least one set of paths')
    
    names = ['cpg', 'lps', 'p3c4', 'tnf']
    datasets = [cpg_dosage_dataset, lps_dosage_dataset, p3c4_dosage_dataset, tnf_dosage_dataset]
